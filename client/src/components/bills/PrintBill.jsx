...
const PrintBill = ({ isModalOpen, setIsModalOpen, customer }) => {
  ...
  const handlePrint = useReactToPrint({
    content: () => {
      console.log(
        "Yazdırma işlemi tetiklendi, componentRef:",
  ...
  useEffect(() => {
    if (isModalOpen) {
      console.log("Modal açık ve componentRef mevcut:", componentRef.current);
    }
  }, [isModalOpen]);
  return (
    <Modal
        ...
        <Button
          ...
          onClick={() => {
            setTimeout(() => {
              ...
              handlePrint();
            }, 100); // Modal tamamen yüklendikten sonra yazdırma işlemini başlat
          }}
        >
          Yazdır
        </Button>
